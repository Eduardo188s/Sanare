      ...
      <div className="flex items-center space-x-0.5">
        ...
        {hasHalfStar && (
          <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <path fill="url(#half-star-gradient)" d="M9.049 2.927l1.07 3.292a1 1 0 00.95.69h3.462l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034 1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          </svg>
        )}
