    ...
    <div className="flex min-h-screen"> 
        ...
        <div className="grow flex flex-col items-center justify-center text-center p-12 text-white shadow-2xl"> 
          ...
          <p className="text-xl text-justify leading-relaxed max-w-2xl">
            ...
            Somos una plataforma digital diseñada para conectar pacinetes y profesionales de la salud de forma ágil y segura.
            Nuestro objetivo es simplificar la gestiin médica mediante tecnologia intuitiva, permitiendo agendar citas,
            consultar información clínica y optimizar el timepo tanto de médicos como de pacientes. 
          </p>
        </div>
